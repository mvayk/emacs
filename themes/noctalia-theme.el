...
(let* ((bg "#131313")
      ...
      (success "#e1c38c")
      (on-success "#402d04")
      (success-container "#584419")
      (on-success-container "#fedea6")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb3ac")
      (primary-fixed-dim "#7e2b27")
      (secondary-fixed "#e7bdb8")
      (secondary-fixed-dim "#5d3f3c")
      (tertiary-fixed "#e1c38c")
      (tertiary-fixed-dim "#584419")
      (on-primary-fixed "#5f1413")
      (on-primary-fixed-variant "#ffdad6")
      (on-secondary-fixed "#442927")
      (on-secondary-fixed-variant "#ffdad6")
      (on-tertiary-fixed "#402d04")
      (on-tertiary-fixed-variant "#fedea6")
